(custom-set-variables
 ...
 '(my-chosen-theme 'standard-light t)
 '(org-agenda-files
 ...
 '(package-selected-packages
   '(darkroom frame logos olivetti standard-themes org-contrib evil-magit magit counsel-projectile projectile mu4e-overview mu4e-alert request dap-mode lsp-treemacs org-super-agenda flycheck-pos-tip pdf-tools plantuml-mode auctex flycheck-popup-tip flycheck-posframe flycheck auto-package-update modus-themes zen-mode undo-tree dashboard noflet mood-line vterm evil-nerd-commenter company-box company treemacs-nerd-icons lsp-java lsp-ivy lsp-ui lsp-mode dired-single hydra undo-fu doom-themes org-habit nerd-icons-dired org-superstar-mode ivy-prescient prescient popper rainbow-delimiters general exec-path-from-shell helpful ivy-rich org-archive markdown-mode counsel swiper ivy calfw-org calfw org-contacts diary evil-surround org-web-tools eyebrowse sourcerer which-key evil-collection diminish))
