...
This setup is heavily inspired by [[https://github.com/MatthewZMD/.emacs.d][M-EMACS]] by [[https://github.com/MatthewZMD][Matthew Zeng]].
...
Hide window decorations (title bar) and set rounded corners on macOS.
